...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="../css/style_xbox.css" type="text/css">
  <!-- FontAwesome -->
          ...
          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark mycolor">
                ...
                <li><a class="dropdown-item active" href="xbox.php">Xbox</a></li>
    ...
    <div class="container pt-3 pb-2 container-principal">
      <div class="row mymargen">
        <div class="col-sm-12 col-md-9 col-lg-9 col-xl-9">
          <h2 class="titulo"><i class="fa-brands fa-xbox icon"></i> Noticias <span class="marca">Xbox</span></h2>
          <article class="carta">
            <a href="news/xbox/noticia3.php" class="carta__thumbnail">
            ...
            <div class="carta__info blog-meta big-meta col-md-8">
              <h3 class="carta__title">
                <b><a href="news/xbox/noticia3.php" class="carta__link-title">El jefe de Xbox espera que cada vez haya menos juegos exclusivos.</a></b>
              </h3>
            ...
            <a href="news/xbox/noticia3.php" class="boton boton--more">
          ...
          <hr>
          <article class="carta">
            <a href="news/xbox/noticia2.php" class="carta__thumbnail">
              <img src="../assets/img/noticia2/ds-790x444.webp" alt="Imagen de Mordhau" class="carta__image img-fluid">
            </a>
            <div class="carta__info blog-meta big-meta col-md-8">
              <h3 class="carta__title">
                <b><a href="news/xbox/noticia2.php" class="carta__link-title">Así es el nuevo tráiler de Death Stranding que celebra su llegada a PC Game Pass.</a></b>
              </h3>
              <a href="xbox.php" class="btn btn-sm mb-2 boton-xbox">Xbox</a>
            ...
            <a href="news/xbox/noticia2.php" class="boton boton--more">
              <span class="boton__text">Leer más...</span>
              <i class="boton__icon fas fa-arrow-right"></i>
            </a>
          </article>
          <hr>
          <article class="carta">
            <a href="news/xbox/noticia1.php" class="carta__thumbnail">
              <img src="../assets/img/noticia1/Mordhau-360x203.webp" alt="Imagen de Paisaje" class="carta__image img-fluid">
            </a>
            <div class="carta__info blog-meta big-meta col-md-8">
              <h3 class="carta__title">
                <b><a href="news/xbox/noticia1.php" class="carta__link-title">Así es Mordhau, el nuevo slasher medieval multijugador que llegará muy pronto a Xbox.</a></b>
              </h3>
              <a href="xbox.php" class="btn btn-sm mb-2 boton-xbox">Xbox</a>
            ...
            <a href="news/xbox/noticia1.php" class="boton boton--more">
              <span class="boton__text">Leer más...</span>
              <i class="boton__icon fas fa-arrow-right"></i>
            </a>
          </article>
