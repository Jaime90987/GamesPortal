...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="../css/style_nintendo.css" type="text/css">
  <!-- FontAwesome -->
          ...
          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark mycolor">
                ...
                <li><a class="dropdown-item active" href="nintendo.php">Nintendo</a></li>
              </ul>
            </li>
            <li class="nav-item">
    ...
    <div class="container pt-3 pb-2 container-principal">
      <div class="row mymargen">
        <div class="col-sm-12 col-md-9 col-lg-9 col-xl-9">
          <h2 class="titulo"><i class="fa-solid fa-gamepad icon"></i> Noticias <span class="marca">Nintendo</span></h2>
          <article class="carta">
            <a href="news/nintendo/noticia3.php" class="carta__thumbnail">
            ...
            <div class="carta__info blog-meta big-meta col-md-8">
              <h3 class="carta__title">
                <b><a href="news/nintendo/noticia3.php" class="carta__link-title">La demo de Splatoon 3 ya se puede descargar gratis.</a></b>
              </h3>
            ...
            <a href="news/nintendo/noticia3.php" class="boton boton--more">
          ...
          <hr>
          <article class="carta">
            <a href="news/nintendo/noticia2.php" class="carta__thumbnail">
              <img src="../assets/img/noticia2/hori-Split-Pad-Fit-Cropped.webp" alt="Imagen de x" class="carta__image img-fluid">
            </a>
            <div class="carta__info blog-meta big-meta col-md-8">
              <h3 class="carta__title">
                <b><a href="news/nintendo/noticia2.php" class="carta__link-title">Anunciado oficialmente el Split Pad Fit, un nuevo mando de HORI para Nintendo Switch.</a></b>
              </h3>
              <a href="nintendo.php" class="btn btn-sm mb-2 boton-nintendo">Nintendo</a>
            ...
            <a href="news/nintendo/noticia2.php" class="boton boton--more">
              <span class="boton__text">Leer más...</span>
              <i class="boton__icon fas fa-arrow-right"></i>
            </a>
          </article>
        <hr>
        <article class="carta">
          <a href="news/nintendo/noticia1.php" class="carta__thumbnail">
            <img src="../assets/img/noticia1/cx4b59571b825f3a-1200x801.webp" alt="Imagen de  X" class="carta__image img-fluid">
          </a>
          <div class="carta__info blog-meta big-meta col-md-8">
            <h3 class="carta__title">
              <b><a href="news/nintendo/noticia1.php" class="carta__link-title">Xenoblade Chronicles 3: ¿Cuánto dura el nuevo exclusivo de Nintendo Switch?</a></b>
            </h3>
            <a href="nintendo.php" class="btn btn-sm mb-2 boton-nintendo">Nintendo</a>
          ...
          <a href="news/nintendo/noticia1.php" class="boton boton--more">
            <span class="boton__text">Leer más...</span>
            <i class="boton__icon fas fa-arrow-right"></i>
          </a>
        </article>
