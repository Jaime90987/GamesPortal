    ...
    <div class="container pt-3 pb-2 container-principal">
      <div class="row mymargen">
        <div class="col-sm-12 col-md-9 col-lg-9 col-xl-9">
          <div class="container">
            <h1>Skull and Bones muestra sus requisitos para PC y detalla las características que incluirá de lanzamiento.</h1>
            ...
            <p>A medida que se acerca el lanzamiento de diversos juegos, las compañías van confirmando tanto las características más destacadas como los requisitos para la versión de PC de Skull and Bones. En este caso Ubisoft ha salido a mostrar ambas cosas, y por un lado hay que celebrar la introducción de ciertas características interesantes, mientras que por otro lado, los requisitos son un tanto elevados a partir de 1080p hacia delante.</p>

            
            <p>En el blog oficial de Ubisoft, se ha podido ver tanto los requisitos como sus características. En la imagen está toda la información necesaria para sacar conclusiones. Para reproducir los juegos a baja calidad a 30 FPS y en una resolución de 1080p con un Ryzen 5 1600 ( o i7 4790) y una GTX 1060 de 6 GB será suficiente.</p>

            <img src="../../../assets/img/noticia3/skull_and_bones-5731091.webp" alt="Imagen de GoW" class="carta__image img-fluid mt-2 mb-3 imagen">
  
            <p>Las características más interesantes para este título son que la tasa de FPS no estará capada, compatibilidad con monitores panorámicos y una profunda personalización gráfica para adaptarla a tu gusto. También contará con iluminación mejorada, trazado de rayos y una tecnología que resultará muy útil, DLSS y FSR.</p>
  
            <p>Como características adicionales de este título, mencionar que Skull and Bones tiene un enfoque muy alejado de un juego narrativo. Lo que sí que será es un título que aportará una gran personalización, diversos tipos de barcos y armamento. Con estas cosas, algunos desarrolladores no confían en que el título vaya a ser un éxito.</p>
